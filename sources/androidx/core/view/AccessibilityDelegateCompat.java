...
public class AccessibilityDelegateCompat {
    ...
    public boolean performAccessibilityAction(View host, int action, Bundle args) {
        ...
        if (success || action != C0113R.C0115id.accessibility_action_clickable_span) {
            return success;
        }
    ...
    private boolean performClickableSpanAction(int clickableSpanId, View host) {
        SparseArray<WeakReference<ClickableSpan>> spans = (SparseArray) host.getTag(C0113R.C0115id.tag_accessibility_clickable_spans);
        if (spans != null) {
    ...
    static List<AccessibilityActionCompat> getActionList(View view) {
        List<AccessibilityActionCompat> actions = (List) view.getTag(C0113R.C0115id.tag_accessibility_actions);

...
public class TypedArrayUtils {
    ...
    @Nullable
    public static ColorStateList getNamedColorStateList(@NonNull TypedArray a, @NonNull XmlPullParser parser, @Nullable Theme theme, @NonNull String attrName, @StyleableRes int resId) {
        if (!hasAttribute(parser, attrName)) {
            return null;
        }
        TypedValue value = new TypedValue();

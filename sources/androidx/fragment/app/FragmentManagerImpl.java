...
final class FragmentManagerImpl extends FragmentManager implements Factory2 {
    ...
    public void moveToState(androidx.fragment.app.Fragment r19, int r20, int r21, int r22, boolean r23) {
        ...
        L_0x0247:
            ...
            android.content.res.Resources r0 = r19.getResources()     // Catch:{ NotFoundException -> 0x0262 }
            int r3 = r8.mContainerId     // Catch:{ NotFoundException -> 0x0262 }
            java.lang.String r0 = r0.getResourceName(r3)     // Catch:{ NotFoundException -> 0x0262 }
            goto L_0x0265
        L_0x0262:
            r0 = move-exception
        ...
        if (state != null) {
            ...
            if (fms.mActive != null) {
                ...
                if (fms.mPrimaryNavActiveWho != null) {
                    this.mPrimaryNav = (Fragment) this.mActive.get(fms.mPrimaryNavActiveWho);

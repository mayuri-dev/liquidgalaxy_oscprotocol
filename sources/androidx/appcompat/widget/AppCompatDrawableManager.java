            ...
            if (INSTANCE == null) {
                ...
                INSTANCE.mResourceManager.setHooks(new ResourceManagerHooks() {
                    ...
                    private ColorStateList createButtonColorStateList(@NonNull Context context, @ColorInt int baseColor) {
                        ...
                        int colorControlHighlight = ThemeUtils.getThemeAttrColor(context, C0008R.attr.colorControlHighlight);
                        int disabledColor = ThemeUtils.getDisabledThemeAttrColor(context, C0008R.attr.colorButtonNormal);
                    ...
                    private ColorStateList createSwitchThumbColorStateList(Context context) {
                        ...
                        ColorStateList thumbColor = ThemeUtils.getThemeAttrColorStateList(context, C0008R.attr.colorSwitchThumbNormal);
                        if (thumbColor == null || !thumbColor.isStateful()) {
                            states[0] = ThemeUtils.DISABLED_STATE_SET;
                            colors[0] = ThemeUtils.getDisabledThemeAttrColor(context, C0008R.attr.colorSwitchThumbNormal);
                            int i = 0 + 1;
                            states[i] = ThemeUtils.CHECKED_STATE_SET;
                            colors[i] = ThemeUtils.getThemeAttrColor(context, C0008R.attr.colorControlActivated);
                            int i2 = i + 1;
                            states[i2] = ThemeUtils.EMPTY_STATE_SET;
                            colors[i2] = ThemeUtils.getThemeAttrColor(context, C0008R.attr.colorSwitchThumbNormal);
                            int i3 = i2 + 1;
                        } else {
                            states[0] = ThemeUtils.DISABLED_STATE_SET;
                            ...
                            colors[i4] = ThemeUtils.getThemeAttrColor(context, C0008R.attr.colorControlActivated);
                            int i5 = i4 + 1;
                    ...
                    public Drawable createDrawableFor(@NonNull ResourceManagerInternal resourceManager, @NonNull Context context, int resId) {
                        if (resId != C0008R.C0009drawable.abc_cab_background_top_material) {
                            return null;
                        }
                        return new LayerDrawable(new Drawable[]{resourceManager.getDrawable(context, C0008R.C0009drawable.abc_cab_background_internal_bg), resourceManager.getDrawable(context, C0008R.C0009drawable.abc_cab_background_top_mtrl_alpha)});
                    }
                    ...
                    public boolean tintDrawable(@NonNull Context context, int resId, @NonNull Drawable drawable) {
                        if (resId == C0008R.C0009drawable.abc_seekbar_track_material) {
                            LayerDrawable ld = (LayerDrawable) drawable;
                            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908288), ThemeUtils.getThemeAttrColor(context, C0008R.attr.colorControlNormal), AppCompatDrawableManager.DEFAULT_MODE);
                            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0008R.attr.colorControlNormal), AppCompatDrawableManager.DEFAULT_MODE);
                            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0008R.attr.colorControlActivated), AppCompatDrawableManager.DEFAULT_MODE);
                            return true;
                        } else if (resId != C0008R.C0009drawable.abc_ratingbar_material && resId != C0008R.C0009drawable.abc_ratingbar_indicator_material && resId != C0008R.C0009drawable.abc_ratingbar_small_material) {
                            return false;
                        } else {
                            LayerDrawable ld2 = (LayerDrawable) drawable;
                            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908288), ThemeUtils.getDisabledThemeAttrColor(context, C0008R.attr.colorControlNormal), AppCompatDrawableManager.DEFAULT_MODE);
                            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0008R.attr.colorControlActivated), AppCompatDrawableManager.DEFAULT_MODE);
                            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0008R.attr.colorControlActivated), AppCompatDrawableManager.DEFAULT_MODE);
                            return true;
                        }
                    }
                    ...
                    public ColorStateList getTintListForDrawableRes(@NonNull Context context, int resId) {
                        if (resId == C0008R.C0009drawable.abc_edit_text_material) {
                            return AppCompatResources.getColorStateList(context, C0008R.color.abc_tint_edittext);
                        }
                        if (resId == C0008R.C0009drawable.abc_switch_track_mtrl_alpha) {
                            return AppCompatResources.getColorStateList(context, C0008R.color.abc_tint_switch_track);
                        }
                        if (resId == C0008R.C0009drawable.abc_switch_thumb_material) {
                            return createSwitchThumbColorStateList(context);
                        }
                        if (resId == C0008R.C0009drawable.abc_btn_default_mtrl_shape) {
                            return createDefaultButtonColorStateList(context);
                        }
                        if (resId == C0008R.C0009drawable.abc_btn_borderless_material) {
                            return createBorderlessButtonColorStateList(context);
                        }
                        if (resId == C0008R.C0009drawable.abc_btn_colored_material) {
                            return createColoredButtonColorStateList(context);
                        }
                        if (resId == C0008R.C0009drawable.abc_spinner_mtrl_am_alpha || resId == C0008R.C0009drawable.abc_spinner_textfield_background_material) {
                        ...
                        if (resId == C0008R.C0009drawable.abc_seekbar_thumb_material) {
                    ...
                    public boolean tintDrawableUsingColorFilter(@NonNull Context context, int resId, @NonNull Drawable drawable) {
                        ...
                        if (arrayContains(this.COLORFILTER_TINT_COLOR_CONTROL_NORMAL, resId)) {
                            colorAttr = C0008R.attr.colorControlNormal;
                            colorAttrSet = true;
                        } else if (arrayContains(this.COLORFILTER_COLOR_CONTROL_ACTIVATED, resId)) {
                            colorAttr = C0008R.attr.colorControlActivated;
                            colorAttrSet = true;
                        } else if (arrayContains(this.COLORFILTER_COLOR_BACKGROUND_MULTIPLY, resId)) {
                            colorAttr = 16842801;
                            colorAttrSet = true;
                            tintMode = Mode.MULTIPLY;
                        } else if (resId == C0008R.C0009drawable.abc_list_divider_mtrl_alpha) {
                            colorAttr = 16842800;
                            colorAttrSet = true;
                            alpha = Math.round(40.8f);
                        } else if (resId == C0008R.C0009drawable.abc_dialog_material_background) {
                            colorAttr = 16842801;
                            colorAttrSet = true;
                        }
                        if (!colorAttrSet) {

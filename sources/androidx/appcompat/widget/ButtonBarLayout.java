...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray ta = context.obtainStyledAttributes(attrs, C0008R.styleable.ButtonBarLayout);
        if (VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0008R.styleable.ButtonBarLayout, attrs, ta, 0, 0);
        }
        this.mAllowStacking = ta.getBoolean(C0008R.styleable.ButtonBarLayout_allowStacking, true);
        ta.recycle();
    }
    ...
    private void setStacked(boolean stacked) {
        ...
        View spacer = findViewById(C0008R.C0010id.spacer);
        if (spacer != null) {

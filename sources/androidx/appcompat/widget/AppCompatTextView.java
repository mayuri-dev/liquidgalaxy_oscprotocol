...
public class AppCompatTextView extends TextView implements TintableBackgroundView, TintableCompoundDrawablesView, AutoSizeableTextView {
    ...
    public void setFirstBaselineToTopHeight(@C0007Px @IntRange(from = 0) int firstBaselineToTopHeight) {
    ...
    public void setLastBaselineToBottomHeight(@C0007Px @IntRange(from = 0) int lastBaselineToBottomHeight) {
        if (VERSION.SDK_INT >= 28) {
    ...
    public void setLineHeight(@C0007Px @IntRange(from = 0) int lineHeight) {
    ...
    @RestrictTo({Scope.LIBRARY_GROUP_PREFIX})
    public void setSupportCompoundDrawablesTintMode(@Nullable Mode tintMode) {

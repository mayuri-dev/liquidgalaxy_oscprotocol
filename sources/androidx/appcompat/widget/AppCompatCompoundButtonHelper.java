...
class AppCompatCompoundButtonHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        TypedArray a = this.mView.getContext().obtainStyledAttributes(attrs, C0008R.styleable.CompoundButton, defStyleAttr, 0);
        boolean buttonDrawableLoaded = false;
        try {
            if (a.hasValue(C0008R.styleable.CompoundButton_buttonCompat)) {
                int resourceId = a.getResourceId(C0008R.styleable.CompoundButton_buttonCompat, 0);
                if (resourceId != 0) {
                    try {
            ...
            if (!buttonDrawableLoaded) {
                if (a.hasValue(C0008R.styleable.CompoundButton_android_button)) {
                    int resourceId2 = a.getResourceId(C0008R.styleable.CompoundButton_android_button, 0);
                    if (resourceId2 != 0) {
                        this.mView.setButtonDrawable(AppCompatResources.getDrawable(this.mView.getContext(), resourceId2));
                    }
                }
            }
            if (a.hasValue(C0008R.styleable.CompoundButton_buttonTint)) {
                CompoundButtonCompat.setButtonTintList(this.mView, a.getColorStateList(C0008R.styleable.CompoundButton_buttonTint));
            }
            if (a.hasValue(C0008R.styleable.CompoundButton_buttonTintMode)) {
                CompoundButtonCompat.setButtonTintMode(this.mView, DrawableUtils.parseTintMode(a.getInt(C0008R.styleable.CompoundButton_buttonTintMode, -1), null));
            }
        } finally {
            a.recycle();
        }

...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        if (numPoints > 0) {
            ...
            if (((double) Math.abs(this.f31mX[0])) > 1.0E-5d || ((double) Math.abs(this.f32mY[0])) > 1.0E-5d || ((double) Math.abs(this.f31mX[numPoints - 1] - 1.0f)) > 1.0E-5d || ((double) Math.abs(this.f32mY[numPoints - 1] - 1.0f)) > 1.0E-5d) {
                StringBuilder sb = new StringBuilder();
                sb.append("The Path must start at (0,0) and end at (1,1) start: ");
                sb.append(this.f31mX[0]);
                String str = ",";
                sb.append(str);
                sb.append(this.f32mY[0]);
                sb.append(" end:");
                sb.append(this.f31mX[numPoints - 1]);
                sb.append(str);
                sb.append(this.f32mY[numPoints - 1]);

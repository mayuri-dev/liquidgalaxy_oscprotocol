...
public final class ViewGroupCompat {
    ...
    public static void setTransitionGroup(@NonNull ViewGroup group, boolean isTransitionGroup) {
        if (VERSION.SDK_INT >= 21) {
            ...
            group.setTag(C0113R.C0115id.tag_transition_group, Boolean.valueOf(isTransitionGroup));
        }
    }
    ...
    public static boolean isTransitionGroup(@NonNull ViewGroup group) {
        ...
        Boolean explicit = (Boolean) group.getTag(C0113R.C0115id.tag_transition_group);
